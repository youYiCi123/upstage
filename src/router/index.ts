    ...
    children: [
      {
        path: "survey",
        name: "survey",
        component: () => import("@/views/business/writeFile/survey/index.vue"),
        meta: { title: "问卷中心" },
      },
      {
        path: "active",
        name: "active",
        component: () => import("@/views/business/writeFile/active/index.vue"),
        meta: { title: "活动中心" },
      },
      {
        path: "activeTemps",
      ...
      },
      {
        path: "template",
        name: "template",
        component: () => import("@/views/business/writeFile/temp/index.vue"),
        meta: { title: "模板列表" },
      },
      {
        path: "field",
