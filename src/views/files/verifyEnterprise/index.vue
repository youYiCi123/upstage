...
function showMusic(row: any) {
    openNewPage('/preview/music/' + row.parentId + '/' + row.fileId + '/' + panUtil.fileFold.ENTERPRISEBYVERIFY, 'PreviewMusic', {
        pageType: panUtil.fileFold.ENTERPRISEBYVERIFY,
...
function showVideo(row: any) {
    openNewPage('/preview/video/' + row.parentId + '/' + row.fileId + '/' + panUtil.fileFold.ENTERPRISEBYVERIFY, 'PreviewVideo', {
        pageType: panUtil.fileFold.ENTERPRISEBYVERIFY,
        fileId: row.fileId,
        parentId: row.parentId
    })
